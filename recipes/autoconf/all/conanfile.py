...
class AutoconfConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        if self.settings.os == "Windows":
            # Handle vagaries of Windows line endings (review)
    ...
    def package_info(self):
        ...
        self.buildenv_info.define_path("AUTOCONF", "autoconf")
        ...
        self.buildenv_info.define_path("AUTORECONF", "autoreconf")
        ...
        self.buildenv_info.define_path("AUTOHEADER", "autoheader")

        autom4te_bin = os.path.join(bin_path, "autom4te")
        self.output.info(f"Defining AUTOM4TE environment variable: {autom4te_bin}")
        self.buildenv_info.define_path("AUTOM4TE", "autom4te")

        # TODO: to remove in conan v2
        self.env_info.PATH.append(bin_path)
        # self.env_info.AC_MACRODIR = dataroot_path.replace("\\", "/")
        # self.env_info.AUTOM4TE_PERLLIBDIR = dataroot_path.replace("\\",  "/")
