...
The following summarizes the process for contributing to Conan Center Index.
...
The `conan-center-index` repository is an Open Source MIT licensed project; it is developed by the Conan maintainers and a great community of contributors.
The CI infrastructure is provided and maintained by the Conan team at JFrog.
...
> [!NOTE]
> A good issue report should answer the following questions:<br>
> 1️⃣ What command did you run? (steps to reproduce)<br>
> 2️⃣ Environment and preconditions<br>
> 3️⃣ What did you expect to happen?<br>
> 4️⃣ What happened instead?<br>
...
- The outcome you got instead - please include the full output of the command (log)<br>
   Please avoid unnecessarily clipping command logs, as they contain useful information. We recommend you always include the following:
   
  - The exact command invoked with all its arguments
  - The following sections near the beginning of the Conan output:
    - "Input profiles"
    - "Computing dependency graph"
    - "Computing necessary packages"
  - The full build system configuration log (CMake, Meson, autotools, ...)
